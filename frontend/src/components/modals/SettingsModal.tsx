...
type SettingsSection =
  "general" | "appearance" | "concurrency" | "integrations" | "diagnostics";
  ...
  onMount(async () => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (isResizing()) {
        ...
        const newW = Math.max(
          580,
          Math.min(1200, resizeStartPos.width + deltaX),
        );
        const newH = Math.max(
          420,
          Math.min(900, resizeStartPos.height + deltaY),
        );
        setModalWidth(newW);
        setModalHeight(newH);
      }
      ...
      <div class="fixed inset-0 bg-black/65 backdrop-blur-sm z-50 flex items-center justify-center p-4 select-none animate-in fade-in duration-150">
        ...
        >
            ...
            <div class="flex-1 p-6 overflow-y-auto bg-carbon-surface space-y-6">
                ...
                <div class="space-y-6">
                  <div>
                    ...
                    <p class="text-[11.5px] text-gray-400">
                      Configure background Git polling behavior and command
                      runner defaults.
                    </p>
                  </div>
                  ...
                  <div class="space-y-2">
                    <label class="block text-gray-200 font-medium">
                      Automatic Background Fetch Interval
                    </label>
                    <CustomSelect
                    ...
                    <p class="text-[11px] text-gray-500">
                      Executes lightweight background checks to update
                      ahead/behind counts without holding index locks.
                    </p>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <p class="text-[11px] text-gray-500">
                      Standard system binary discovered on $PATH.
                    </p>
                  </div>
                  ...
                  <div class="pt-2 border-t border-carbon-border">
                    <label class="flex items-center gap-2.5 cursor-pointer text-gray-200">
                      ...
                      <span class="font-medium">
                        Safely skip dirty repositories during batch Pull All
                        operations
                      </span>
                    </label>
                  </div>
              ...
              <Show when={activeSection() === "appearance"}>
                <div class="space-y-6">
                  <div>
                    <h3 class="text-sm font-bold text-gray-100 mb-1">
                      Appearance, Colors & Profiles
                    </h3>
                    <p class="text-[11.5px] text-gray-400">
                      Customize themes, custom palette colors, system fonts, and
                      saved profiles.
                    </p>
                  </div>
                          ...
                          return (
                            ...
                            >
                              <div class="flex items-center justify-between mb-2">
                                <div
                                  class={`p-1.5 rounded ${isSelected() ? "bg-git-indigo text-white" : "bg-carbon-elevated text-gray-400"}`}
                                >
                                  <Icon class="w-4 h-4" />
                                </div>
                              ...
                              <div>
                                ...
                                <p class="text-[10.5px] text-gray-400 mt-0.5 leading-tight">
                                  {t.desc}
                                </p>
                              </div>
                            </button>
                    ...
                    <div class="p-4 bg-carbon-base border border-git-indigo/40 rounded-lg space-y-3 animate-in fade-in duration-150">
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                          <label class="block text-gray-400 text-[11px]">
                            Background Color
                          </label>
                          <div class="flex items-center gap-2">
                            <input
                      ...
                      <For each={accentOptions}>
                        {(acc) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                class={`w-3 h-3 rounded-full ${acc.colorClass}`}
                              />
                              <span>{acc.label}</span>
                            </button>
                          );
                  ...
                  <div class="space-y-2">
                    <label class="block text-gray-200 font-medium flex items-center justify-between">
                      ...
                      <span class="text-[11px] text-gray-400 font-normal">
                        Supports all installed system fonts
                      </span>
                    </label>
                        ...
                        {(f) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span class="text-[11px] text-gray-400 font-mono mt-1 block">
                                {f.preview}
                              </span>
                            </button>
                          );
                    ...
                    <Show when={settings().fontFamily === "custom"}>
                      <div class="p-3 bg-carbon-base border border-carbon-border rounded-lg space-y-2 mt-2">
                        ...
                        />
                        <p class="text-[11px] text-gray-500">
                          Type any font installed on your Linux system
                  ...
                  <div class="space-y-2 pt-2 border-t border-carbon-border">
                    <div class="flex items-center justify-between text-gray-200 font-medium">
                      ...
                      <span class="font-mono text-git-indigo font-bold text-xs">
                    ...
                    <p class="text-[11px] text-gray-500">
                      Dynamically scales overall UI information density,
                      typography size, and element spacing.
                    </p>
                  </div>
                          ...
                          return (
                            <div class="px-4 py-2.5 flex items-center justify-between hover:bg-carbon-hover transition-colors">
                              <div class="flex items-center gap-2.5">
                                <div
                                  class={`w-2.5 h-2.5 rounded-full ${isActive() ? "bg-git-emerald" : "bg-gray-600"}`}
                                />
                                <span
                                  class={`font-medium ${isActive() ? "text-white font-bold" : "text-gray-300"}`}
                                >
                                  {pName}
                                </span>
                                <Show when={isActive()}>
                              ...
                              <div class="flex items-center gap-2">
                                <Show when={!isActive()}>
                                  ...
                                  <Show when={pName !== "Default Dark"}>
                                    <button
                                      onClick={() =>
                                        settingsStore.deleteAppearanceProfile(
                                          pName,
                                        )
                                      }
              ...
              <Show when={activeSection() === "concurrency"}>
                <div class="space-y-6">
                  <div>
                    ...
                    <p class="text-[11.5px] text-gray-400">
                      Scale thread pools for parallel repository operations.
                    </p>
                  </div>
                  ...
                  <div class="space-y-2">
                    <div class="flex items-center justify-between text-gray-200 font-medium">
                      ...
                      <span class="font-mono text-git-indigo font-bold text-sm">
                    ...
                    />
                    <p class="text-[11px] text-gray-500">
                      Bounded concurrency pool throttles simultaneous Git
                      sub-processes to eliminate network socket contention.
                    </p>
                  </div>
                  ...
                  <div class="p-3.5 bg-carbon-base border border-carbon-border rounded-lg space-y-1.5">
                    ...
                    <p class="text-[11.5px] text-gray-400">
                      All background and batch Git processes execute with{" "}
                      <code class="text-git-cyan font-mono">
              ...
              <Show when={activeSection() === "integrations"}>
                <div class="space-y-6">
                  <div>
                    <h3 class="text-sm font-bold text-gray-100 mb-1">
                      CLI & SSH Integrations
                    </h3>
                    <p class="text-[11.5px] text-gray-400">
                      Seamless integration with your terminal tooling and
                      credentials.
                    </p>
                  </div>
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="text-[11px] text-gray-400">
                            Cloning remote repositories, PR and auth integration
                          </p>
                        </div>
                      </div>
                      <span
                        class={`px-2 py-1 rounded text-xs font-semibold ${cliAuth().gh ? "bg-git-emerald/20 text-git-emerald border border-git-emerald/40" : "bg-gray-800 text-gray-500"}`}
                      >
                    ...
                    <div class="flex items-center justify-between p-3.5 bg-carbon-base border border-carbon-border rounded-lg">
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="text-[11px] text-gray-400">
                            GitLab project discovery and merge requests
                          </p>
                        </div>
                      </div>
                      <span
                        class={`px-2 py-1 rounded text-xs font-semibold ${cliAuth().glab ? "bg-git-emerald/20 text-git-emerald border border-git-emerald/40" : "bg-gray-800 text-gray-500"}`}
                      >
              ...
              <Show when={activeSection() === "diagnostics"}>
                <div class="space-y-6">
                  <div>
                    ...
                    <p class="text-[11.5px] text-gray-400">
                      Real-time memory and system performance metrics.
                    </p>
                  </div>
                    ...
                    {(s) => (
                      <div class="grid grid-cols-2 gap-3 font-mono text-xs">
                        <div class="p-3.5 bg-carbon-base border border-carbon-border rounded-lg">
                          ...
                          <strong class="text-git-emerald text-base">
                        ...
                        <div class="p-3.5 bg-carbon-base border border-carbon-border rounded-lg">
                          ...
                          <strong class="text-gray-200 text-base">
                        ...
                        <div class="p-3.5 bg-carbon-base border border-carbon-border rounded-lg">
                          ...
                          <strong class="text-git-indigo text-base">
                            {s().numGoroutine}
                          </strong>
                        </div>
                        <div class="p-3.5 bg-carbon-base border border-carbon-border rounded-lg">
                  ...
                  <div class="text-[11px] text-gray-500 p-3 bg-carbon-base border border-carbon-border rounded-lg space-y-1">
                    <p class="font-semibold text-gray-400">
                      Zero-CGO SQLite Database:
                    </p>
                    <code class="text-gray-300 font-mono block truncate">
                      ~/.config/onogitree/onogitree.db
                    </code>
                  </div>
                </div>
              </Show>
          ...
          >
            <svg
              viewBox="0 0 6 6"
              class="w-2.5 h-2.5 text-gray-400 fill-current"
            >
